...
let getSalario = (empleado) => {
    return new Promise((resolve, reject) => {
        ...
        if (!salarioDB) {
            reject(`No existe salario para el usuario ${empleado.name}`);
        } else {
...
//se anidan las peticiones con varios then cada thern represena a un resultado del calback anterior el catch es centralizado sirve para cualquier errr
